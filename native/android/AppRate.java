...
class AppRate implements android.content.DialogInterface.OnClickListener, OnCancelListener {
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			try
			{
				if (MonkeyConfig.APPRATE_AMAZON.equals("1")) {
				    hostActivity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("amzn://apps/android?p=" + hostActivity.getPackageName())));
				} else {
